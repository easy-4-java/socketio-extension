...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/socketio-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)

socketio-extension is a set of extensions and utilities for the Netty-SocketIO server library
...
```groovy
implementation 'io.github.easy4j:socketio-extension:3.0.x.x.20260630-SNAPSHOT'
```
